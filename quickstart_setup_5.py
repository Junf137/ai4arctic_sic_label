...
# -- Built-in modules -- #
from utils import CHARTS, SIC_LOOKUP, SOD_LOOKUP, FLOE_LOOKUP, SCENE_VARIABLES5, colour_str
...
train_options = {
    'experiment_name': 'Input_Channel_Experiment_Setup5_xinwei_val', # To be replaced once config file is working. 
    # -- Training options -- #
    ...
    'train_variables': SCENE_VARIABLES5,
